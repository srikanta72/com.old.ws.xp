...
public class IRCTCServiceSIE_bootTicket_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws java.lang.Exception {
        ...
        ns2_myPassengerInfo_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, in.co.irctc.web.provider.PassengerInfo.class, ns2_PassengerInfo_TYPE_QNAME);
    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_PassengerInfo_2_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setPassengerInfo_2((in.co.irctc.web.provider.PassengerInfo)member);
                }
                reader.nextElementContent();
            }
        }
