...
public class Ola_Service_SerializerRegistry implements SerializerConstants {
    ...
    public TypeMappingRegistry getRegistry() {
        ...
        TypeMapping mapping2 = registry.getTypeMapping("");
        {
            ...
            CombinedSerializer serializer = new com.ola.partner.service.Ola_bookRide_ResponseStruct2_SOAPSerializer(type,
            ...
            registerSerializer(mapping,com.ola.partner.service.Ola_bookRide_ResponseStruct2.class, type, serializer);
        }
        {
            QName type = new QName("http://ola.com/cabs/types", "ride-details");
            CombinedSerializer serializer = new com.ola.partner.service.RideDetails_SOAPSerializer(type,
            ...
            registerSerializer(mapping,com.ola.partner.service.RideDetails.class, type, serializer);
        }
        {
            QName type = new QName("http://ola.com/cabs/types", "trip");
            CombinedSerializer serializer = new com.ola.partner.service.Trip_SOAPSerializer(type,
                ENCODE_TYPE, NULLABLE, SOAPConstants.NS_SOAP_ENCODING);
            serializer = new ReferenceableSerializerImpl(SERIALIZE_AS_REF, serializer, SOAPVersion.SOAP_11);
            registerSerializer(mapping,com.ola.partner.service.Trip.class, type, serializer);
        }
        {
            QName type = new QName("http://ola.com/cabs/services", "bookRide");
            CombinedSerializer serializer = new com.ola.partner.service.Ola_bookRide_RequestStruct2_SOAPSerializer(type,
                DONT_ENCODE_TYPE, NULLABLE, SOAPConstants.NS_SOAP_ENCODING);
            serializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF, serializer, SOAPVersion.SOAP_11);
            registerSerializer(mapping,com.ola.partner.service.Ola_bookRide_RequestStruct2.class, type, serializer);
        }
        {
            QName type = new QName("http://ola.com/cabs/types", "passenger");
            CombinedSerializer serializer = new com.ola.partner.service.Passenger_SOAPSerializer(type,
                ENCODE_TYPE, NULLABLE, SOAPConstants.NS_SOAP_ENCODING);
            serializer = new ReferenceableSerializerImpl(SERIALIZE_AS_REF, serializer, SOAPVersion.SOAP_11);
            registerSerializer(mapping,com.ola.partner.service.Passenger.class, type, serializer);
        }
        return registry;
    }
