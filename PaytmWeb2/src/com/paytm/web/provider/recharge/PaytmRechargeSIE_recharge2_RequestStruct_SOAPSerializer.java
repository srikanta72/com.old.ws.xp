...
public class PaytmRechargeSIE_recharge2_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public PaytmRechargeSIE_recharge2_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.paytm.web.provider.recharge.PaytmRechargeSIE_recharge2_RequestStruct instance = new com.paytm.web.provider.recharge.PaytmRechargeSIE_recharge2_RequestStruct();
        com.paytm.web.provider.recharge.PaytmRechargeSIE_recharge2_RequestStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_long_1_QNAME)) {
                member = ns2_myns2__long__long_Long_Serializer.deserialize(ns1_long_1_QNAME, reader, context);
                instance.setLong_1(((Long)member).longValue());
                reader.nextElementContent();
            }
        }
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_String_2_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.paytm.web.provider.recharge.PaytmRechargeSIE_recharge2_RequestStruct_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_String_3_QNAME)) {
                member = ns2_myns2_string__java_lang_String_String_Serializer.deserialize(ns1_String_3_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.paytm.web.provider.recharge.PaytmRechargeSIE_recharge2_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.paytm.web.provider.recharge.PaytmRechargeSIE_recharge2_RequestStruct instance = (com.paytm.web.provider.recharge.PaytmRechargeSIE_recharge2_RequestStruct)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns2_myns2__long__long_Long_Serializer.serialize(new Long(instance.getLong_1()), ns1_long_1_QNAME, null, writer, context);
        ...
        ns2_myns2_string__java_lang_String_String_Serializer.serialize(instance.getString_3(), ns1_String_3_QNAME, null, writer, context);
    }
}
