...
public class Ticket_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.irctc.web.provider.Ticket instance = new com.irctc.web.provider.Ticket();
        com.irctc.web.provider.Ticket_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_seatNo_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.irctc.web.provider.Ticket_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.irctc.web.provider.Ticket instance = (com.irctc.web.provider.Ticket)obj;
