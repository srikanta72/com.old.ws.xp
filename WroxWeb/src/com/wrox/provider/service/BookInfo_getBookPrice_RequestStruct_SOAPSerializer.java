...
public class BookInfo_getBookPrice_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.wrox.provider.service.BookInfo_getBookPrice_RequestStruct instance = new com.wrox.provider.service.BookInfo_getBookPrice_RequestStruct();
        com.wrox.provider.service.BookInfo_getBookPrice_RequestStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_String_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.wrox.provider.service.BookInfo_getBookPrice_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.wrox.provider.service.BookInfo_getBookPrice_RequestStruct instance = (com.wrox.provider.service.BookInfo_getBookPrice_RequestStruct)obj;
