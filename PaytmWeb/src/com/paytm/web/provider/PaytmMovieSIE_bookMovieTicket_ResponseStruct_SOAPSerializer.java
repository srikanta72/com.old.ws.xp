...
public class PaytmMovieSIE_bookMovieTicket_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public PaytmMovieSIE_bookMovieTicket_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.paytm.web.provider.PaytmMovieSIE_bookMovieTicket_ResponseStruct instance = new com.paytm.web.provider.PaytmMovieSIE_bookMovieTicket_ResponseStruct();
        com.paytm.web.provider.PaytmMovieSIE_bookMovieTicket_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_result_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.paytm.web.provider.PaytmMovieSIE_bookMovieTicket_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.paytm.web.provider.PaytmMovieSIE_bookMovieTicket_ResponseStruct instance = (com.paytm.web.provider.PaytmMovieSIE_bookMovieTicket_ResponseStruct)obj;
