...
public class PaytmMovieSIE_bookMovieTicket_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public PaytmMovieSIE_bookMovieTicket_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.paytm.web.provider.PaytmMovieSIE_bookMovieTicket_RequestStruct instance = new com.paytm.web.provider.PaytmMovieSIE_bookMovieTicket_RequestStruct();
        com.paytm.web.provider.PaytmMovieSIE_bookMovieTicket_RequestStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_String_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.paytm.web.provider.PaytmMovieSIE_bookMovieTicket_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.paytm.web.provider.PaytmMovieSIE_bookMovieTicket_RequestStruct instance = (com.paytm.web.provider.PaytmMovieSIE_bookMovieTicket_RequestStruct)obj;
